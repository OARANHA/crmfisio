...
COMMENT ON FUNCTION public.guard_finalized_appointment_financial_source() IS
  'Prevents authenticated users from changing patient, clinic, amount or package after appointment finalization; protects materialized financial source.';
