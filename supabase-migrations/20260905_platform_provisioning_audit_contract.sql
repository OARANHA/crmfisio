-- MEDICSPRO — hotfix: align clinic provisioning with governed platform_audit_log contract
...
IS 'Idempotent clinic provisioning finalizer aligned with governed platform audit contract.';
