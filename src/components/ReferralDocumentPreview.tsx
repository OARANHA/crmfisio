...
import type { ReferralPayload } from '../lib/clinicalReferral';
import { useCurrentUserAccess } from '../lib/currentUserAccess';
import { buildReferralDocumentHtml } from '../lib/referralPrintRenderer';
import type { Patient } from '../lib/types';

type ReferralDocumentPreviewProps = {
  patient: Patient;
...
export function ReferralDocumentPreview({ patient, payload, renderDefinition, clinic }: ReferralDocumentPreviewProps) {
  ...
  return (
    <section className="self-start overflow-hidden rounded-2xl border border-line/65 bg-panel 2xl:sticky 2xl:top-4" data-referral-live-preview="draft">
      ...
      <div className="bg-deep/35 p-3 sm:p-4">
        <iframe
          title="Pré-visualização do encaminhamento clínico"
          srcDoc={html}
          sandbox=""
