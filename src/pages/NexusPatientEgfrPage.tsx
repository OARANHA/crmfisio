...
import { NexusEgfrPanel } from '../components/NexusEgfrPanel';
import { useApp } from '../lib/store';
import { isClinicManager } from '../lib/permissions';
import { Card, Empty } from '../lib/ui';

export function NexusPatientEgfrPage() {
  const { id } = useParams();
