...
VALUES ('00000000-0000-0000-0000-000000000111','00000000-0000-0000-0000-000000000001','professional',true,false,'medico','CRM','SP','CARE-READ-APPLY')
...
-- Deliberately differs from professional_id: the pre-fix runtime misses this
-- relationship, while the reconciled helper must recognize appointments.fisio_id.
INSERT INTO public.appointments(id,clinic_id,paciente_id,fisio_id,professional_id)
VALUES ('00000000-0000-0000-0000-000000000511','00000000-0000-0000-0000-000000000001','00000000-0000-0000-0000-000000000302','00000000-0000-0000-0000-000000000111','00000000-0000-0000-0000-000000000109')
ON CONFLICT (id) DO NOTHING;
