...
- [ ] **PCL-5 Clinician-Assisted V1 (#491)** — PR aberta; próxima ferramenta Nexus selecionada; clinician-assisted only, cutoff brasileiro versionado `>=36`, sem auto-enable e sem `patient_self`.
