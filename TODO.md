...
- [x] Fazer smoke visual/autenticado do Consultório / Gestão (#396), especialmente owner/admin elegível, professional clinical-only, mobile e URL administrativa protegida. Fechado em 2026-09-17 após #502/#504/#505: `P0_396_SMOKE=PASS`, desktop/mobile light-dark sem overflow e privacy boundary validado em produção.
...
- [x] #502 — preservar tri-state da elegibilidade clínica do PresentationContext para owner/admin; erro técnico mantém Consultório fail-closed, informa falha e oferece retry em vez de aparentar negação clínica. Produção verificada em 2026-09-17; o P0 visual/autenticado #396 foi fechado depois de #504/#505.
- [x] #506 — remover leitura tenant de `automation_runs` global, mantendo `automation_settings` clinic-scoped e telemetria de execução exclusivamente no RPC do Platform Admin. Produção verificada em 2026-09-17, sem mudança de grants/RLS/backend.
