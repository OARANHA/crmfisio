...
| PCL-5 | **Em implementação clinician-assisted V1** | Regra versionada `nexus-pcl5-br-2026-09-16`; forma brasileira sem Critério A somente após trauma avaliado por outro meio; cutoff operacional BR `>=36`; fail-closed, sem `patient_self` |
