...
| PC-PTSD-5 | **PROD / VERIFIED / tenant enablement required (#495)** | Gate de trauma + 5 itens; tradução operacional PT-BR sem validação brasileira reclamada; cutoff operacional externo `>=4`; fail-closed, sem auto-enable e sem `patient_self` |
